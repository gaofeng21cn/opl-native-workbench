...
test("OCI carrier runs only the Node headless host with persistent non-root defaults", async () => {
  ...
  assert.match(dockerfile, /ARG OPL_APP_REF=9aa8c5065df6649c7a7e06b4d458a100fae1f67b/);
  ...
  assert.match(compose, /OPL_APP_REF:-9aa8c5065df6649c7a7e06b4d458a100fae1f67b/);
