...
test("OCI carrier runs only the Node headless host with persistent non-root defaults", async () => {
  ...
  assert.match(dockerfile, /ARG OPL_FRAMEWORK_REF=98f9bfa714270550d3e1906a13bce2baf0fac822/);
  assert.match(dockerfile, /ARG OPL_APP_REF=9ce9e2f9b42927d1d37d332da93b54bda65f74aa/);
  ...
  assert.match(compose, /OPL_FRAMEWORK_REF:-98f9bfa714270550d3e1906a13bce2baf0fac822/);
  assert.match(compose, /OPL_APP_REF:-9ce9e2f9b42927d1d37d332da93b54bda65f74aa/);
