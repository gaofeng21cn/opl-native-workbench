...
function installNativeTransport(): boolean {
  ...
  window.oplStudio = {
    ...
    steerTurn: (request) => post("steerTurn", request as Record<string, unknown>),
    interruptTurn: (request) => post("interruptTurn", request as Record<string, unknown>),
    loginGatewayAccount: (request) => post("loginGatewayAccount", request as Record<string, unknown>),
    readNativeAppUpdateStatus: () => post("readNativeAppUpdateStatus"),
    checkNativeAppUpdate: () => post("checkNativeAppUpdate"),
    applyNativeAppUpdate: () => post("applyNativeAppUpdate"),
    restartNativeApp: () => post("restartNativeApp"),
