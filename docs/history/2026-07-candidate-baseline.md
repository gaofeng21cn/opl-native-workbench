...
The implementation used ChatGPT Codex macOS 26.707.41301, inspected on
2026-07-11, and the 26.707.61608 visual style, inspected on 2026-07-13, as
references for a persistent rail, dominant conversation timeline, compact
header, composer controls, floating environment details, and a quiet light
workbench. No Codex source, brand asset, OpenAI Sans font binary, or product
authority was copied.

Current visual/product requirements belong to One Person Lab App contracts and
GUI docs. This dated observation cannot override a newer App baseline.
